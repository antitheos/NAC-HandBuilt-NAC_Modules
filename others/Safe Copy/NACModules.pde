...
void setup() {
  ...
  modulesJ = new PShape[16];  
  modulesK = new PShape[16];  
  modulesN = new PShape[16];  
  modulesO = new PShape[16];  
  modulesS = new PShape[16];  
  ...
  for (int i=0; i< modulesA.length; i++) { 
    ...
    modulesJ[i] = loadShape("L_"+nf(i,2)+".svg");
    modulesK[i] = loadShape("M_"+nf(i,2)+".svg");
    modulesN[i] = loadShape("N_"+nf(i,2)+".svg");
    modulesO[i] = loadShape("O_"+nf(i,2)+".svg");
    modulesS[i] = loadShape("S_"+nf(i,2)+".svg");
    ...
    modulesJ[i].disableStyle();
    modulesK[i].disableStyle();
    modulesN[i].disableStyle();
    modulesO[i].disableStyle();
    modulesS[i].disableStyle();
    ...
    for (int gridX=1; gridX< gridResolutionX-1; gridX++) { 
      ...
      if (currentTile != '0') {
        ...
        case 'H': 
          ...
          break;
        case 'J': 
          shape(modulesJ[decimalResult],posX, posY, tileSize, tileSize);
          break;
        case 'K': 
          shape(modulesK[decimalResult],posX, posY, tileSize, tileSize);
          break;
        case 'N': 
          shape(modulesN[decimalResult],posX, posY, tileSize, tileSize);
          break;
        case 'O': 
          shape(modulesO[decimalResult],posX, posY, tileSize, tileSize);
          break;
        case 'S': 
          shape(modulesS[decimalResult],posX, posY, tileSize, tileSize);
          break;
        case 'T': 
...
void keyReleased() {
  ...
  if (key == 'a' || key == 'A') activeModulsSet = 'A';
  ...
  if (key == '9') activeModulsSet = 'J';
  if (key == '0') activeModulsSet = 'K';
  if (key == 'q' || key == 'Q') activeModulsSet = 'N';
  if (key == 'w' || key == 'W') activeModulsSet = 'O';
  if (key == 'e' || key == 'E') activeModulsSet = 'S';
  ...
  if (key == 'b' || key == 'B') activeTileColor = color(#bdbdbd);
